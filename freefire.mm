...
static void INIT_PATCH_NAME(void) {
    ...
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x20C37BC"), ENCRYPTHEX("20008052C0035FD6"));  // FJHAGCJDKPN <<< QUAN TRỌNG
    ...
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x20C6E14"), ENCRYPTHEX("20008052C0035FD6"));  // GKCOOPMPOAD <<< QUAN TRỌNG
    ...
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x20C58F4"), ENCRYPTHEX("20008052C0035FD6"));  // OCACPLNFBPA <<< QUAN TRỌNG
    ...
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x20C53D0"), ENCRYPTHEX("20008052C0035FD6"));  // DPLMGOJKKCM <<< QUAN TRỌNG
    ...
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x20C45F8"), ENCRYPTHEX("20008052C0035FD6"));  // PPHNIPHEIND <<< QUAN TRỌNG
    ...
    // ========== HOOK FUNCTIONS ==========
    // reset guest
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x4DE1380"), nullptr);
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x6D7BF54"), nullptr);
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x53C4414"), nullptr);

    // no recoil
    StaticInlineHookPatchInMemory(_kLx59qEfBdwU, ENCRYPTOFFSET("0x58EB108"), nullptr);
    ...
    // ========== NHÓM 1: KHỞI TẠO ANTICHEAT (BLOCK TRƯỚC) ==========
    ActiveOff(ENCRYPTOFFSET("0x20C3604"), ENCRYPTHEX("20008052C0035FD6"));  // MPOLNCNGCIJ
    ActiveOff(ENCRYPTOFFSET("0x20C370C"), ENCRYPTHEX("20008052C0035FD6"));  // CCNEAFOPMIH
    ActiveOff(ENCRYPTOFFSET("0x20C37BC"), ENCRYPTHEX("20008052C0035FD6"));  // FJHAGCJDKPN
    ActiveOff(ENCRYPTOFFSET("0x20C37FC"), ENCRYPTHEX("20008052C0035FD6"));  // JKGFBIEOBDF
    ActiveOff(ENCRYPTOFFSET("0x20C38A8"), ENCRYPTHEX("20008052C0035FD6"));  // FCPFCIPPOPK

    // ========== NHÓM 2: PHÁT HIỆN JAILBREAK/ROOT ==========
    ActiveOff(ENCRYPTOFFSET("0x20C6E14"), ENCRYPTHEX("20008052C0035FD6"));  // GKCOOPMPOAD
    ActiveOff(ENCRYPTOFFSET("0x20C4830"), ENCRYPTHEX("20008052C0035FD6"));  // GKCOOPMPOAD (bản sao)
    ActiveOff(ENCRYPTOFFSET("0x20C4770"), ENCRYPTHEX("20008052C0035FD6"));  // BPIPBKMFCMG
    ActiveOff(ENCRYPTOFFSET("0x20C5A74"), ENCRYPTHEX("20008052C0035FD6"));  // CEOJKAOPHGO
    ActiveOff(ENCRYPTOFFSET("0x20C58A0"), ENCRYPTHEX("20008052C0035FD6"));  // ABADPLJONOE
    ActiveOff(ENCRYPTOFFSET("0x20C6914"), ENCRYPTHEX("20008052C0035FD6"));  // MHPEBFEBHBM

    // ========== NHÓM 3: PHÁT HIỆN CÔNG CỤ HACK ==========
    ActiveOff(ENCRYPTOFFSET("0x20C58F4"), ENCRYPTHEX("20008052C0035FD6"));  // OCACPLNFBPA
    ActiveOff(ENCRYPTOFFSET("0x20C604C"), ENCRYPTHEX("20008052C0035FD6"));  // KPBDLLPJONE
    ActiveOff(ENCRYPTOFFSET("0x20C59B4"), ENCRYPTHEX("20008052C0035FD6"));  // FAOMGBAGJJJ
    ActiveOff(ENCRYPTOFFSET("0x20C7C24"), ENCRYPTHEX("20008052C0035FD6"));  // INFEDEMBEHD
    ActiveOff(ENCRYPTOFFSET("0x20C7F48"), ENCRYPTHEX("20008052C0035FD6"));  // JKEPBNKCHPB
    ActiveOff(ENCRYPTOFFSET("0x20C80D0"), ENCRYPTHEX("20008052C0035FD6"));  // EIKKLILOJIC

    // ========== NHÓM 4: PHÁT HIỆN FILE/SYSTEM ==========
    ActiveOff(ENCRYPTOFFSET("0x20C5F48"), ENCRYPTHEX("20008052C0035FD6"));  // NENABJENJMM
    ActiveOff(ENCRYPTOFFSET("0x20C7674"), ENCRYPTHEX("20008052C0035FD6"));  // NDECONJAANP
    ActiveOff(ENCRYPTOFFSET("0x20C685C"), ENCRYPTHEX("20008052C0035FD6"));  // DCAKIEGMNCM
    ActiveOff(ENCRYPTOFFSET("0x20C6C50"), ENCRYPTHEX("20008052C0035FD6"));  // PDJBHMNNOFO

    // ========== NHÓM 5: KIỂM TRA BYPASS ==========
    ActiveOff(ENCRYPTOFFSET("0x20C53D0"), ENCRYPTHEX("20008052C0035FD6"));  // DPLMGOJKKCM
    ActiveOff(ENCRYPTOFFSET("0x20C5BF4"), ENCRYPTHEX("20008052C0035FD6"));  // NHMEPDOOFOM
    ActiveOff(ENCRYPTOFFSET("0x20C6150"), ENCRYPTHEX("20008052C0035FD6"));  // BJM
    ActiveOff(ENCRYPTOFFSET("0x20C6274"), ENCRYPTHEX("20008052C0035FD6"));  // GALCFBPEAGP

    // ========== NHÓM 6: NATIVE VERIFY ==========
    ActiveOff(ENCRYPTOFFSET("0x20C5798"), ENCRYPTHEX("20008052C0035FD6"));  // NCEDCLGBKEJ
    ActiveOff(ENCRYPTOFFSET("0x20C6754"), ENCRYPTHEX("20008052C0035FD6"));  // LFEIBIDPLAC
    ActiveOff(ENCRYPTOFFSET("0x20C7734"), ENCRYPTHEX("20008052C0035FD6"));  // MHOGKHLGFAM
    ActiveOff(ENCRYPTOFFSET("0x20C7818"), ENCRYPTHEX("20008052C0035FD6"));  // DEOGPFEEJMK
    ActiveOff(ENCRYPTOFFSET("0x20C7910"), ENCRYPTHEX("20008052C0035FD6"));  // FBPAHIHOCA
    ActiveOff(ENCRYPTOFFSET("0x20C7A68"), ENCRYPTHEX("20008052C0035FD6"));  // OJIGLLPKPHG

    // ========== NHÓM 7: GỬI BÁO CÁO LÊN SERVER ==========
    ActiveOff(ENCRYPTOFFSET("0x20C45F8"), ENCRYPTHEX("20008052C0035FD6"));  // PPHNIPHEIND
    ActiveOff(ENCRYPTOFFSET("0x20C7488"), ENCRYPTHEX("20008052C0035FD6"));  // FLMFAFGODFJ
    ActiveOff(ENCRYPTOFFSET("0x20C3E44"), ENCRYPTHEX("20008052C0035FD6"));  // LOEBJODHEPP
    ActiveOff(ENCRYPTOFFSET("0x20C3D34"), ENCRYPTHEX("20008052C0035FD6"));  // IFHCGBANGKC

    // ========== NHÓM 8: KẾT NỐI SERVER ==========
    ActiveOff(ENCRYPTOFFSET("0x20C4BE0"), ENCRYPTHEX("20008052C0035FD6"));  // KCCPOHCKDPK
    ActiveOff(ENCRYPTOFFSET("0x20C4C20"), ENCRYPTHEX("20008052C0035FD6"));  // ILANNAADPLB
    ActiveOff(ENCRYPTOFFSET("0x20C464C"), ENCRYPTHEX("20008052C0035FD6"));  // OFNLFFJMJCO
    ActiveOff(ENCRYPTOFFSET("0x20C3EE8"), ENCRYPTHEX("20008052C0035FD6"));  // DJELBEFGCAK

    // ========== NHÓM 9: QUÉT MÔI TRƯỜNG ==========
    ActiveOff(ENCRYPTOFFSET("0x20C436C"), ENCRYPTHEX("20008052C0035FD6"));  // LLKDEPINNNO
    ActiveOff(ENCRYPTOFFSET("0x20C442C"), ENCRYPTHEX("20008052C0035FD6"));  // NOGIJINMKME
    ActiveOff(ENCRYPTOFFSET("0x20C6540"), ENCRYPTHEX("20008052C0035FD6"));  // EIBDMAOPDDO
    ActiveOff(ENCRYPTOFFSET("0x20C7110"), ENCRYPTHEX("20008052C0035FD6"));  // DOCMDGFCMJA
    ActiveOff(ENCRYPTOFFSET("0x20C3FA4"), ENCRYPTHEX("20008052C0035FD6"));  // DPPPFBHIHJA
    ActiveOff(ENCRYPTOFFSET("0x20C6F44"), ENCRYPTHEX("20008052C0035FD6"));  // LDLNEBJCLOL

    // ========== NHÓM 10: MÃ HÓA/BẢO MẬT ==========
    ActiveOff(ENCRYPTOFFSET("0x20C487C"), ENCRYPTHEX("20008052C0035FD6"));  // HCLNNKDOKKP
    ActiveOff(ENCRYPTOFFSET("0x20C4BA0"), ENCRYPTHEX("20008052C0035FD6"));  // PAFBNEPKJIC
    ActiveOff(ENCRYPTOFFSET("0x20C3ADC"), ENCRYPTHEX("20008052C0035FD6"));  // LHAJPJBCOLC
    ActiveOff(ENCRYPTOFFSET("0x20C3BE8"), ENCRYPTHEX("20008052C0035FD6"));  // HBMHNPDKIPB

    // ========== NHÓM 11: MẠNG ==========
    ActiveOff(ENCRYPTOFFSET("0x20C7634"), ENCRYPTHEX("20008052C0035FD6"));  // EIBPMKJFHBK
    ActiveOff(ENCRYPTOFFSET("0x20C5B34"), ENCRYPTHEX("20008052C0035FD6"));  // IFGAOKEGIHN
    ActiveOff(ENCRYPTOFFSET("0x20C75F4"), ENCRYPTHEX("20008052C0035FD6"));  // GNMEPLCBOEM

    // ========== NHÓM 12: TIỆN ÍCH ==========
    ActiveOff(ENCRYPTOFFSET("0x20C3954"), ENCRYPTHEX("20008052C0035FD6"));  // FHLKFMCHCCD
    ActiveOff(ENCRYPTOFFSET("0x20C7538"), ENCRYPTHEX("20008052C0035FD6"));  // AICLOIGOCEK
    ActiveOff(ENCRYPTOFFSET("0x20C757C"), ENCRYPTHEX("20008052C0035FD6"));  // KEKDDKNHPFJ
    ActiveOff(ENCRYPTOFFSET("0x20C81C0"), ENCRYPTHEX("20008052C0035FD6"));  // PMFNDDEJPKC
    ActiveOff(ENCRYPTOFFSET("0x20C46C4"), ENCRYPTHEX("20008052C0035FD6"));  // KBFNIGNNKLP

    // ========== HOOK FUNCTIONS ==========
    InlineHook(ENCRYPTOFFSET("0x4DE1380"), resetguesthook, resetguestoriginal);
    InlineHook(ENCRYPTOFFSET("0x6D7BF54"), force120fpshook, force120fpsoriginal);
    InlineHook(ENCRYPTOFFSET("0x53C4414"), hook_get_InSwapWeaponCD, orig_get_InSwapWeaponCD);
    InlineHook(ENCRYPTOFFSET("0x58EB108"), hook_KHHMBLDMKEN, orig_KHHMBLDMKEN);
#endif
}
