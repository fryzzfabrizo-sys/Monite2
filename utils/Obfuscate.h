...
#define NSSENCRYPT(Str) NSSENCRYPT_NS(Str)
#define NSSENCRYPT_NS(Str) @(ENCRYPT(Str))
#define NSSENCRYPT_CSTR(str) [@(ENCRYPT(str)) UTF8String]
#define ENCRYPT_NS(str) [NSString stringWithUTF8String:ENCRYPT(str)]
#endif
